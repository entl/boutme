...
<template>
	...
	>
		...
		<div class="w-full md:w-1/3 text-left">
			...
			>
				The 2nd year Computer Science student
      </p>
      <p
      ...
      <p
          class="font-general-medium mt-2 text-base sm:text-lg xl:text-xl text-center sm:text-left leading-none text-gray-400"
      >
        Specializing in creating efficient and scalable web services using GoLang, Python, and Java.
      </p>
			<div class="flex justify-center sm:block">
				<a
					download="Maksym-CV.pdf"
					href="/files/Maksym-CV.pdf"
